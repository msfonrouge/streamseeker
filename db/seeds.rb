...
principal_user.favorite(movie9, scope: "Mis favoritas")
principal_user.favorite(top_gun, scope: "Mis favoritas")
principal_user.favorite(movie14, scope: "Mis favoritas")
principal_user.favorite(movie2, scope: "Mis favoritas")

Watchlist.create(title: "Bookmarks", user_id: principal_user.id)
principal_user.favorite(movie1, scope: "Bookmarks")
principal_user.favorite(movie4, scope: "Bookmarks")
principal_user.favorite(movie6, scope: "Bookmarks")
principal_user.favorite(movie13, scope: "Bookmarks")
